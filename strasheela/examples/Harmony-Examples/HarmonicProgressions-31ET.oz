...
{Explorer.object
 add(information proc {$ I X}
     ...
     label: 'Csound and Lily output (ET31)')}
...
%%
%% translating the previous example (chord progression without limit to any key) into "proper" homophonic chord progression
%%
