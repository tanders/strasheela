...
*** Sourceforge Mediawiki login

    How is login managed for Sourceforge Mediawiki hosted app?

    It appears wiki editors must be registered at Sourceforge and addditionally somehow for the wiki. How?
    I would like to make registration for wiki contributors as easy as possible. How?? Do I need to set up my own wiki then?
