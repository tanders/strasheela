...
** Markov chain constraints which include probablilty		     :NEXT:WAIT:

   Wait for soft constraints support for Strasheela
   (I realised: this is not so simple: I first need support of _real_ soft constraints)
...
*** TODO Move definitions from Strasheela/tmp.oz into HS.rules 
...
*** TODO Write test suite for testing all constraints 
...
**** TODO [#A] Read soft constraints article in "Handbook of Constraint Programming"
