...
** TODO Go through test files and collect examples there in files in examples folder :MAYBE:
...
** Variant for Out.saveScore using pickles
...
** TODO ENP output: change default Out.outputNonmensuralENP default args such that any Strasheela score topology creates some ENP score (i.e. it works for every Strasheela score topology)
...
*** TODO For further TODOs see in source file     
...
*** TODO Generalise Arg prototypeDependencies:				 :MAYBE:
...
** TODO Define variant of Schoenberg root progression rules using chord primes  :WAIT:
...
**** TODO ?? Add fundamentals / prime (e.g., 5:6:7 and 6:7:9 both have prime 4)
...
**** TODO Revise chord feature essentialPitchClasses     
...
** Output to K Sprottes PWGL simple format				 :MAYBE:
...
** TODO simplify editing _ozrc file					  :NEXT:
...
* Strasheela on Cluster


* Strasheela Bugs

** Archiving score (e.g., with Out.saveScore) with strings: double quotes of strings are lost
