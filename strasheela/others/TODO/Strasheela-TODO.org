...
* Tasks for Le StruM						       :WAIT:
  ...
  [wait for instructions from Eduardo, ~ 12 September 2009]

  Eduardo plans two different options, I will do one of them

** More sophisticated version of existing demo
...
** New 2nd demo
   ...
   for hospital project in London

   Must be easy to install & use.
   Does not require using Strasheela, e.g., could be a plain Max application

   ?? check existing advantages of Max 5 for this purpose, then ask Eduardo to get that...
