...
* Strasheela release							  :NEXT:

** TODO Fix bug for Lily output of (container) offset times 
...
*** DONE Example for single voice polyphony
    CLOSED: [2008-04-09 Wed 20:48]
*** TODO Example creating staffs which last only for container duration

** ET22 example

   modify ET31 cadence example
