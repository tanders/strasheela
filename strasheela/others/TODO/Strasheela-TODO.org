...
** TODO Define ENP score transformations			       :NEXT:
...
** TODO CSP generator/template, also for PWGL interface	       :NEXT:
...
** TODO Port Arno constraint in-critical-band? to Strasheela	       :NEXT:
...
** TODO Improving debugging of CSPs -- collect ideas		       :SOON:
...
** TODO Finish support for grace notes 				       :NEXT:
...
** TODO Finish scale databases for 12-TET in Scala.oz 		       :NEXT:
...
** TODO [#B] Define interface to integrate Strasheela into OpenMusic or PWGL :NEXT:
...
** TODO Define/extend ENP score -> Strasheela score 		       :NEXT:
...
** TODO [#B] Define Strasheela score transformations (instead of plain generation as so far) :NEXT:
...
** Strasheela - Gecode interface (e.g., in new Mozart virtual machine)
