...
**** TODO Create small-scale example which will demonstrate the effect of the procedure filter

**** TODO Read plain Filter definition: how can it be made into the concurrent version
