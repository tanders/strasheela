...
** Brain-Computer interface example: homphonic chord progression	:URGENT:
   DEADLINE: <2008-07-11 Fri>
...
*** TODO Implement output to SuperCollider (via OSC)    
*** TODO Implement output to MIDI (via SC)    
...
** Create small-scale musical example which demonstrates the effect of LUtils.cFilter and LUtils.cFind :SOON:
